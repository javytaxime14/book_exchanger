...
class BooklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create booklist" do
    assert_difference('Booklist.count') do
      post booklists_url, params: { booklist: { book_id: @booklist.book_id, user_id: @booklist.user_id } }
    end
  ...
  test "should update booklist" do
    patch booklist_url(@booklist), params: { booklist: { book_id: @booklist.book_id, user_id: @booklist.user_id } }
